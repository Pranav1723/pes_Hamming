# pes_rca 
(This repository was named  pes_Hamming originally and was a repository for a Hamming code generator, but had to change the design because of some issues with the testbench and the code for the encoder and the deocder modules for the same.
